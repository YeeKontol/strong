...
if __name__ == '__main__':
      with suppress(KeyboardInterrupt):
          with suppress(IndexError):
              ...
              logger.info(
                  f"{bcolors.WARNING}Attack Started to{bcolors.OKGREEN} %s{bcolors.WARNING} with{bcolors.OKGREEN} %s{bcolors.WARNING} method for{bcolors.OKGREEN} %s{bcolors.WARNING} seconds, threads:{bcolors.OKGREEN} %d{bcolors.WARNING}!{bcolors.RESET}"
